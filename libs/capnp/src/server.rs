...
impl chord_capnp::chord_node::Server for NodeServerImpl {
    ...
    fn find_successor(&mut self, params: chord_capnp::chord_node::FindSuccessorParams<>, results: chord_capnp::chord_node::FindSuccessorResults<>) ->  capnp::capability::Promise<(), capnp::Error> {
